...
public class LiftRobotPosition extends Command {
  ...
  protected void initialize() {
    ...
    SmartDashboard.putNumber("Climber/PID Setpoint", m_desiredPos);
    SmartDashboard.putNumber("Climber/Front PID Output", m_frontPosPIDGet);
    SmartDashboard.putNumber("Climber/Back PID Output", m_backPosPIDGet);
  ...
  protected void execute() {
    ...
    SmartDashboard.getEntry("Climber/PID Setpoint").setDouble(m_desiredPos);
    SmartDashboard.getEntry("Climber/Front PID Output").setDouble(m_frontPosPIDGet);
    SmartDashboard.getEntry("Climber/Back PID Output").setDouble(m_backPosPIDGet);

...
public class Limelight {
    ...
    /**
     * Initializes all network table entries, and creates object
     * Turns on vision and LEDs by default  
     */
    public Limelight() {
     ...
     * @return An array containing the x offset and y offset of the target 
     * {xOffset, yOffset}
     */
